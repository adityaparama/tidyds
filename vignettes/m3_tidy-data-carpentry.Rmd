...
`table1` termasuk "Tidy data" karena setiap variabel sudah dalam satu kolom sendiri dan setiap obserasi pada satu row

```{r}
table2
```

`table2` tidak termasuk "Tidy data" karena pada kolom type ada 2 variabel yang digabungkan (cases & population)

```{r}
table3
```

`table3` tidak termasuk "Tidy data" karena pada kolom rate terdapat 2 observasi
...
`table4a` tidak termasuk "Tidy data" karena pada satu buah observasi terdapat 2 data (tahun 1999 dan 2000)

```{r}
table4b
```

`table4b` termasuk "Tidy data" karena karena pada satu buah observasi terdapat 2 data (tahun 1999 dan 2000)

```{r}
table5
```

`table5` tidak termasuk "Tidy data" karena pada setiap observasi, di kolom rate terdapat 2 data
